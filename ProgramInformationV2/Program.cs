...
builder.Services.AddScoped(b => new NoteTemplateCacheClearer(builder.Configuration["NoteTemplateCacheUrl"] ?? "https://courseapi.wigg.illinois.edu/api/RefreshNoteTemplates"));
