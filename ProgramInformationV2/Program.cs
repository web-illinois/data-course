...
builder.Services.AddScoped<NoteTemplateHelper>();
builder.Services.AddScoped<INoteTemplateConvert, NoteTemplateConverter>();
builder.Services.AddScoped(b => new NoteTemplateCacheClearer(string.IsNullOrWhiteSpace(builder.Configuration["NoteTemplateCacheUrl"]) ? "https://courseapi.wigg.illinois.edu/api/RefreshNoteTemplates" : builder.Configuration["NoteTemplateCacheUrl"] ?? "https://courseapi.wigg.illinois.edu/api/RefreshNoteTemplates"));
...
builder.Services.AddScoped<CourseraGenerator>();
builder.Services.AddScoped<CourseraImportManager>();
builder.Services.AddScoped(b => new CanvasGenerator(builder.Configuration["CanvasApiKey"]));
builder.Services.AddScoped<CanvasImportManager>();
