...
namespace ProgramInformationV2.Components.Pages.Audit {
    ...
    public partial class PublicRequirementSets {
        ...
        protected override async Task OnInitializedAsync() {
            ...
            RequirementSetList = await RequirementSetAudits.GetPublicRequirementSetsThatCanBeMadePrivate(await Layout.CheckSource());
        }
    }
}