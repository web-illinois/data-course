...
public class GetCampusCourse(ILogger<GetCampusCourse> logger) {
    ...
    [Function("GetCampusCourse")]
    [OpenApiOperation(operationId: "GetCampusCourse", tags: "Get Course Information", Description = "Get a course from the campus tools. This is using the same course object, but the source and other fields will be blank.")]
