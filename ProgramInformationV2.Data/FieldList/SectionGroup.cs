...
namespace ProgramInformationV2.Data.FieldList {
    ...
    public class SectionGroup : BaseGroup {
        ...
        public SectionGroup() {
            ...
            Instructions = "Customize the fields used for sections. Note that you need to have courses enabled to use sections appropriately, and sections are usually used in conjunction with Electronic Data Warehouse banner data. You can edit custom instructions for each field based on your use case.";
            ...
            FieldItems = [
                ...
                new() { Title = "URL Fragment", CategoryType = CategoryType.Section, FieldType = FieldType.Technical, InitialDescription = "" },
